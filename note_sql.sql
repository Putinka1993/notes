...
❗ IF NULL отсутствие сущности / операции (например, нет начислений, нет списаний)

👉 Заменяй на 0 (COALESCE)

❗ IF NULL означает неизвестное значение (например, цена не указана, дата отсутствует)

👉 НЕ заменяй на 0, оставляй NULL
...
--                      таблица сочетаемости table match
